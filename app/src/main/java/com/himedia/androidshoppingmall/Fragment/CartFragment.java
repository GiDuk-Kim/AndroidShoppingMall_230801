...
public class CartFragment extends Fragment {
    ...
    public void showCartList()
    {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            cartRecycleAdapter.addItem(new ProductBean(row[0], row[1], row[2], imgUrl, row[4]));   // public ProductBean(String goods_id, String goods_title, String goods_price, String imageRes, String goods_qty) {
        }
